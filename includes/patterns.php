...
function register_patterns(): void {
	\register_block_pattern(
		...
		[
			...
			'viewportWidth' => 500,
			'content'       => '<!-- wp:query {"queryId":0,"query":{"postType":"gp_event","gp_events_query":"upcoming","perPage":10},"namespace":"gatherpress-query-loop"} -->
	...
	\register_block_pattern(
		...
		[
			...
			// 'description' => _x( 'Shows the Title, excerpt as well as events date and time.', 'Block pattern description', 'gatherpress-query-loop' ),
			'blockTypes' => [ 'core/query/gatherpress-query-loop' ],
			'content'    => '<!-- wp:query {"queryId":3,"query":{"perPage":3,"pages":0,"offset":0,"postType":"gp_event","gp_events_query":"past","order":"asc","orderBy":"title","inherit":false,"exclude_current":0},"namespace":"gatherpress-query-loop"} -->
	...
	\register_block_pattern(
		...
		[
			...
			'blockTypes' => [ 'core/query/gatherpress-query-loop' ],
			'viewportWidth' => 800,
			'content'    => '<!-- wp:query {"queryId":0,"query":{"postType":"gp_event","gp_events_query":"past","perPage":1,"inherit":false,"offset":0},"namespace":"gatherpress-query-loop","enhancedPagination":true,"metadata":{},"align":"wide"} -->
